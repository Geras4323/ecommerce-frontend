...
export interface DateRangePickerProps {
  ...
  showCompare?: boolean;
  /** Option for showing date range on top */
  showDates?: boolean;
...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  const PresetButton = ({
    ...
    <button
      className={cn(isSelected && "pointer-events-none", "btn btn-ghost")}
      onClick={() => {
        setPreset(preset);
      }}
    >
  ...
  return (
    ...
    >
      <PopoverTrigger asChild>
        <button className="btn btn-ghost btn-sm w-fit border border-secondary/25 py-1 pl-4 pr-5">
          ...
          <div className="-mr-2 scale-125 pl-1 opacity-60">
            {isOpen ? (
              <ChevronUp className="size-4 min-w-4" />
            ) : (
      ...
      <PopoverContent
        align={align}
        sideOffset={5}
        className="w-auto rounded-lg border border-secondary/30 bg-base-100 p-2"
      >
